goog.provide('application.Diceros.CanvasWindow');
...
goog.require('application.Diceros.VectorLayer');
goog.require('application.Diceros.RasterLayer');
 ...
 * @constructor
 */
application.Diceros.CanvasWindow =
function(app, index, opt_width, opt_height) {
  ...
  /**
   * レイヤーリスト
   * @type {Array.<application.Diceros.Layer>}
   */
  this.layers = [];
  /**
   * 現在編集中のレイヤー index
 ...
 */
application.Diceros.CanvasWindow.prototype.canDecorate = function() {
  return false;
};
 ...
 */
application.Diceros.CanvasWindow.prototype.decorateInternal =
function(element) {
 ...
 * ルートノードの作成
 */
application.Diceros.CanvasWindow.prototype.createDom = function() {
 ...
 * イベントの設定
 */
application.Diceros.CanvasWindow.prototype.setEvent = function() {
...
/**
 * レイヤーの追加
 * @param {application.Diceros.LayerType} type
 */
application.Diceros.CanvasWindow.prototype.addLayer =
function (type) {
  var newLayer, layersSize = this.layers.length;

  switch (type) {
  case application.Diceros.LayerType.VECTOR_LAYER:
    newLayer = new application.Diceros.VectorLayer(this.app);
    break;
  case application.Diceros.LayerType.RASTER_LAYER:
    newLayer = new application.Diceros.RasterLayer(this.app);
    break;
  default:
 ...
 * @param {number} index
 */
application.Diceros.CanvasWindow.prototype.selectLayer =
function(index) {
 ...
 * @param {Event} event
 */
application.Diceros.CanvasWindow.prototype.checkCanvasArea =
function(event) {
 ...
 *
 * @return {application.Diceros.Layer}
 */
application.Diceros.CanvasWindow.prototype.getCurrentLayer =
function() {
